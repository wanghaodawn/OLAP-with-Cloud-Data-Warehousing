...
-- start query3_opt
select c_city, s_city, d_year, sum(lo_revenue) as revenue from 
lineorder_opt, dwdate_opt, customer_opt, supplier_opt 
...
interleaved sortkey (lo_orderdate, lo_quantity, lo_discount);
